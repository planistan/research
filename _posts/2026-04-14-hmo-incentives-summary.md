...
The only checks are external: occupant complaints, neighbour pressure, enforcement, and political attention. There is no automatic correction from within the payment or placement system itself.

---

### A Note on Terminology

"Supported housing" sounds like housing that supports people. As a legal and funding category, "supported" or "exempt" accommodation is the classification that unlocks the Housing Benefit treatment that makes these conversions financially attractive. The two things are not the same. This post is about the funding and placement system, not about whether people with housing needs deserve help — they do.
...
- The subsidy is capped at Local Housing Allowance (LHA) rates, which are typically well below actual nightly costs in London.
...
The rent stream from supported placements is unusually stable compared to ordinary private lets: it is largely publicly funded, it does not depend on individual tenants choosing to stay, and it supports a higher income valuation than a comparable house used as a single dwelling.

That makes a specific financial mechanic available:

- Buy and convert a house into rooms.
- Fill it through supported-housing placements.
- Once rent is proven, the property can be valued on its income rather than its bricks-and-mortar value.
- Refinance against that higher valuation, recovering most of the original cash.
- Use that cash for the next conversion.
...
- Poor social outcomes do not automatically reduce financial returns.
...
In a normal rental market quality is disciplined partly by tenants' ability to leave. That mechanism is largely absent here.

- Occupants often have limited practical ability to refuse a placement or move to an alternative.
- The council's immediate incentive is bed availability; quality monitoring is secondary and resource-constrained.
- The funding route means the budget line that matters most is partly insulated from local cost pressure.
...
**Cost**
- What does hotel and B&B temporary accommodation cost the council per household, and how much is recovered through subsidy?
- What is the total public cost — council, DWP, and other — of each pathway?

**Quality**
- What is the complaints and enforcement history for each provider operating locally?
- How many repeat breaches, and what was the outcome?

**Outcomes**
- How long do occupants stay in supported-HMO placements?
- Where do they move next — into settled housing, or back into the system?
- What proportion return to homelessness?
